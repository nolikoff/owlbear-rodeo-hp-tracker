...
export default function BulkEditor(): JSX.Element {
  ...
  const selectionFilter = (token: Token) =>
    ...
    //PL appState.mostRecentSelection.includes(token.item.id) ||
    //PL getIncluded(token.item.id, appState.includedItems)) &&
